...
class AbstractSampler(ABC):
    ...
    def get_sorted_cluster_counter(self, max_shufflable_size=None):
        ...
        for cluster_label in all_clusters:
            semi_sorted_cc[cluster_label] = sorted_cluster_counter[cluster_label]
